...
RAG_KEYWORDS = [
    ...
    "عايز اتخرج", "كام ساعة", "كم ساعة", "عشان يتخرج", "يتخرج", "يجتازها", "معدلي", "معدلي وقع", "هيفصلوني",
...
MENTAL_KEYWORDS = [
    ...
    # Arabic (فصحى)
    "ضغط", "خايف", "خائف", "قلق", "قلقان", "قلقانه", "قلقانة", "محبط", "صعب",
    "تعب", "مرهق", "ضايع", "يأس",
    # Egyptian Arabic (عامية مصرية)
    ...
    "نصايح للمذاكرة", "نصايح للمذاكره", "نصائح للمذاكرة", "نصائح للمذاكره", "محتاج نصايح", "محتاج نصائح", "اذاكر ازاي",
